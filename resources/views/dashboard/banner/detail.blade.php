          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <tbody>
                <tr>
                  <th>Image 1</th>
                  <td><img src="{{ asset('storage/banner/'. $banner->image_1) }}" alt="Image" width="150"></td>
                </tr>
                <tr>
                  <th>Title 1</th>
                ...
                <tr>
                  <th>Image 2</th>
                  <td><img src="{{ asset('storage/banner/'. $banner->image_2) }}" alt="Image" width="150"></td>
                </tr>
                <tr>
                  <th>Title 2</th>
                ...
                <tr>
                  <th>Image 3</th>
                  <td><img src="{{ asset('storage/banner/'. $banner->image_3) }}" alt="Image" width="150"></td>
                </tr>
                <tr>
                  <th>Title 3</th>
