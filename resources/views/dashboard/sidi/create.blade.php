          ...
          <form action="{{ route('sidi.store') }}" method="POST">
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                ...
                <input type="text" name="sidi" id="sidi" value="{{ $sidi }}" class="form-control @error('sidi') is-invalid @enderror" readonly>
                @error('sidi')
            ...
            <div class="form-row">
              <div class="form-group col-md-12">
                ...
                <input type="text" name="gereja" id="gereja" class="form-control @error('gereja') is-invalid @enderror" placeholder="Input gereja sidi">
                @error('gereja')
                  <div class="alert alert-danger mt-2 p-2">{{ $message }}</div>
                @enderror
              </div>
